...
RUN cd /nexus-repository-conda/; sed -i "s/3.15.0-01/${NEXUS_VERSION}-${NEXUS_BUILD}/g" pom.xml; \
    mvn clean package;

FROM sonatype/nexus3:$NEXUS_VERSION
ARG NEXUS_VERSION=3.15.0
ARG NEXUS_BUILD=01
ARG CONDA_VERSION=0.0.1
