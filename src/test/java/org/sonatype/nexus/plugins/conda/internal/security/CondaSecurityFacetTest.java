 ...
 */
package org.sonatype.nexus.plugins.conda.internal.security;
    ...
    extends TestSupport
{
  ...
  public void setupConfig() throws Exception {
    ...
    when(repository.getFormat()).thenReturn(new Format("conda") { });
  ...
  public void testEnsurePermitted_permitted() throws Exception {
    when(contentPermissionChecker.isPermitted(eq("CondaSecurityFacetTest"), eq("conda"), eq(READ), any()))
        .thenReturn(true);
  ...
  public void testEnsurePermitted_notPermitted() throws Exception {
    ...
    verify(contentPermissionChecker).isPermitted(eq("CondaSecurityFacetTest"), eq("conda"), eq(READ), any());
  }
}
